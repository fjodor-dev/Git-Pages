      ...
      $.ajax({url: "https://api.le-systeme-solaire.net/rest/bodies/" + name , success: function(data){
        ...
        for (const key in data) {
          ...
          switch (key) {
            ...
            case "mass": endValue = `${data.mass.massValue} × 10<sup>${data.mass.massExponent}</sup> kg`
              break;
            case "vol": endValue = `${data.vol.volValue} × 10<sup>${data.vol.volExponent}</sup> kg`
              break;
  
            case "moons": endValue = data[key].length
              break;
  
            case "escape":endValue = data[key] + " m/s"
              break;
  
            case "gravity": endValue = data[key] + " m/s<sup>2</sup>"
              break;
  
            case "avgTemp": endValue = data[key] + " k"
              break;
  
            case "sideralOrbit": endValue = data[key] + " days"
              break; 
  
            case "sideralRotation": endValue = data[key] + " hours"
              break;
  
            case "density": endValue = data[key] + " g/cm<sup>3</sup>"
              break;
  
            case "mainAnomaly":
            case "inclination":
            case "axialTilt": endValue = data[key] + "°"
              break;
            ...
            case "polarRadius": 
            case "equaRadius": 
            case "meanRadius": endValue = data[key] + " km"
              break;
  
            default: endValue = data[key]
              break;
          }
